...
\begin{DoxyCompactList}\small\item\em Read a part of file. // TODO docs\+: offset from the beggining; zero length is ok. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Write a part of file. // TODO docs\+: offset from the beggining; zero length is ok; if offset + bytes.\+length() $>$ eof append. \end{DoxyCompactList}\item 
...
Read a part of file. // TODO docs\+: offset from the beggining; zero length is ok. 
...
Write a part of file. // TODO docs\+: offset from the beggining; zero length is ok; if offset + bytes.\+length() $>$ eof append. 
