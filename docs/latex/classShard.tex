...
\begin{DoxyCompactList}\small\item\em Read a value directly from storage. Used when \mbox{\hyperlink{classCacheMap}{Cache\+Map}} is hit. \end{DoxyCompactList}\item 
std\+::optional$<$ \mbox{\hyperlink{classValue}{Value}} $>$ \mbox{\hyperlink{classShard_aae37746aba37dc3691c2f3098144e81e}{read\+Value}} (\mbox{\hyperlink{classKey}{Key}} key)
\item 
...
\begin{DoxyCompactList}\small\item\em Used when a deleted element in \mbox{\hyperlink{classCacheMap}{Cache\+Map}} is hit. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Get the shard index that contains the @key. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Get the shard index that contains the @key. 
...
Used when a deleted element in \mbox{\hyperlink{classCacheMap}{Cache\+Map}} is hit. 

\mbox{\Hypertarget{classShard_aae37746aba37dc3691c2f3098144e81e}\label{classShard_aae37746aba37dc3691c2f3098144e81e}} 
...
{\footnotesize\ttfamily std\+::optional$<$\mbox{\hyperlink{classValue}{Value}}$>$ Shard\+::read\+Value (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classKey}{Key}}}]{key }\end{DoxyParamCaption})}
...
Read a value directly from storage. Used when \mbox{\hyperlink{classCacheMap}{Cache\+Map}} is hit. 
...
\item 
\mbox{\hyperlink{Shard_8h}{Shard.\+h}}\end{DoxyCompactItemize}
