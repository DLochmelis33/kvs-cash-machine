...
A single part of \mbox{\hyperlink{classKVS}{KVS}} after sharding. Contains a \mbox{\hyperlink{classBloomFilter}{Bloom\+Filter}} and loads hash tables into RAM from disk when necessary.  
...
\begin{center}
\leavevmode
\includegraphics[width=346pt]{classShard__coll__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Write a \mbox{\hyperlink{classValue}{Value}} to this shard. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Remove a \mbox{\hyperlink{classValue}{Value}} from this shard. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Read a \mbox{\hyperlink{classValue}{Value}} directly from disk storage. Used when \mbox{\hyperlink{classCacheMap}{Cache\+Map}} entry is hit. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Get the index of a shard that contains the \mbox{\hyperlink{classKey}{Key}}. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\hyperlink{classBloomFilter}{Bloom\+Filter}} \mbox{\hyperlink{classShard_a7671964f2e07a41c9786b6a8e3d5302f}{filter}}
...
Get the index of a shard that contains the \mbox{\hyperlink{classKey}{Key}}. 
...
pair.\+first -\/ the \mbox{\hyperlink{structEntry}{Entry}} corresponding to the \mbox{\hyperlink{classKey}{Key}}. Used to update the \mbox{\hyperlink{classCacheMap}{Cache\+Map}}. 

pair.\+second -\/ the actual \mbox{\hyperlink{classValue}{Value}} or nothing, if none is present. 
\end{DoxyReturn}
...
Read a \mbox{\hyperlink{classValue}{Value}} directly from disk storage. Used when \mbox{\hyperlink{classCacheMap}{Cache\+Map}} entry is hit. 
...
\begin{DoxyReturn}{Returns}
The read \mbox{\hyperlink{classValue}{Value}}. If the \mbox{\hyperlink{classPtr}{Ptr}} points to a nonexistent \mbox{\hyperlink{classValue}{Value}}, the behavior is undefined. 
\end{DoxyReturn}
...
Remove a \mbox{\hyperlink{classValue}{Value}} from this shard. 

Can also handle delayed removals.

\begin{DoxyReturn}{Returns}
The new \mbox{\hyperlink{structEntry}{Entry}} that corresponds to given \mbox{\hyperlink{classKey}{Key}}. 
\end{DoxyReturn}
...
Write a \mbox{\hyperlink{classValue}{Value}} to this shard. 

\begin{DoxyReturn}{Returns}
Either the old or the new \mbox{\hyperlink{structEntry}{Entry}} that corresponds to given \mbox{\hyperlink{classKey}{Key}}. 
\end{DoxyReturn}
...
{\footnotesize\ttfamily \mbox{\hyperlink{classBloomFilter}{Bloom\+Filter}} Shard\+::filter\hspace{0.3cm}{\ttfamily [private]}}
